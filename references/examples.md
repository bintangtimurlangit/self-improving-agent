...
- **Notes**: Added to AGENTS.md, SOUL.md, or TOOLS.md for future reference

---
```

## Learning: Promoted to AGENTS.md, SOUL.md, or TOOLS.md
...
**Priority**: high
**Status**: promoted
**Promoted**: AGENTS.md, SOUL.md, or TOOLS.md
**Area**: backend
