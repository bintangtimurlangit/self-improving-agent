...
Log learnings to `memory/learning/` for continuous improvement.
...
1. **In-session**: Log to `memory/learning/` as usual
...
| Skill issue | Log to memory/learning/ or report upstream |
...
1. Verify `memory/learning/` directory exists
